    ...
    internal sealed class PR16_ReposMustLinkCorrectCodeOfConduct: PolicyRule
    {
        ...
        public override async Task GetViolationsAsync(PolicyAnalysisContext context)
        {
            ...
            foreach (var repo in context.Org.Repos)
            {
                ...
                if (coc != null)
                {
                    var containsExpectedLink = coc.Content.IndexOf(expectedLink, StringComparison.OrdinalIgnoreCase) >= 0;
                ...
                if (coc != null)
                    CheckForProblematicReferences(coc.Name, coc.HtmlUrl, coc.Content);
